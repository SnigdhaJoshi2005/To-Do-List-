...
export default function Dashboard() {
  ...
  return (
    <div className="py-6" style={{ animation: "fadeIn 0.4s ease-out" }}>
      ...
      <div
        className="flex flex-col items-center gap-0.5 py-4 cursor-pointer text-dim hover:text-secondary transition-colors duration-[var(--transition)]"
        onClick={() =>
      ...
      >
        ...
        <span className="text-lg animate-[scrollBounce_2s_ease-in-out_infinite]">
          ↓
        </span>
      </div>
      ...
      <div className="pb-10">
        {weeklyQuests.length > 0 && (
          <div className="mb-6">
            <h2 className="font-[var(--font-display)] text-xl text-primary mb-3 flex items-center gap-2">
              <span>📅</span> Weekly
            </h2>
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-col gap-2.5">
            {dailyQuests.length === 0 ? (
              <div className="text-center py-10 text-secondary bg-surface/50 rounded-[var(--radius-lg)] border border-border/50 border-dashed">
        ...
        <form className="flex gap-2.5 mt-5" onSubmit={handleQuickAdd}>
          <input
            className="flex-1 px-4 py-3 border-2 border-border rounded-[var(--radius-md)] bg-surface text-primary text-sm focus:border-accent focus:shadow-[0_0_0_3px_rgba(156,175,136,0.1)] transition-all duration-[var(--transition)] placeholder:text-dim"
            type="text"
